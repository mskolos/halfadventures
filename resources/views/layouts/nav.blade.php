                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a style="color:#636b6f" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ Auth::user()->name }} <span class="caret"></span>
                            </a>

                            <div style="color:#636b6f" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
